...
[![Version](https://img.shields.io/badge/version-2.17.14-111111.svg)](VERSION)
...
本次更新（v2.17.14）：README 新增 skills.sh 动态安装量徽章，可直接查看 dbskill 的累计安装数据和各 Skill 安装量。
...
| 把本地文件夹变成知识库 | `/dbs-knowledge` | 知识库导航、版本规则与可直接使用的提问入口 |
